...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $user['password'])) {
            // User credentials are correct, set session variables and redirect to dashboard
        ...
        // No user found with the given email, display error message
...
<body>
    <div class="login-container">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
           ...
           <button><a href="user_registration.php">Register</a></button>
        </form>
    </div>
</body>
<!-- <script>
